...
<meta charset="UTF-8">
    ...
    // Check if the user has any current rentals
    $stmt = $conn->prepare("SELECT * FROM current_rentals WHERE user_id = ?;");
    ...
    if ($rows > 0) {
        // If the user has current rentals
        // Display the movies in their current rentals
        echo '<h1>Current Rentals</h1>';
        ...
        // If the user does not have any current rentals
        echo '<h1>No Current Rentals</h1>';
    }
